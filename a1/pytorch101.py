...
def multiples_of_ten(start, stop):
  ...
  if j==0:
  	...
  	x = torch.tensor([1, j], dtype=torch.float64)
  # x = None
  #############################################################################
  #                    TODO: Implement this function                          #
  #############################################################################
...
def zero_row_min(x):
  ...
  # Replace "pass" statement with your code
  y = x.clone()
  idx0 = torch.argmin(y,dim=1)
  idx1 = torch.arange(y.shape[0])
  y[idx1,idx0] = 0
  #############################################################################
  #                            END OF YOUR CODE                               #
  #############################################################################
